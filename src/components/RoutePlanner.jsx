    ...
    <>
      ...
      <section className="w-full h-16 bg-greenT flex justify-center px-8">
        <Button
          onClick={onOpen}
          isIconOnly
          className="text-greenT text-3xl rounded-full flex justify-center items-center w-14 h-14 border-2 border-greenT bg-white font-semibold mt-[-20px] z-[2000]"
        >
          <LuMapPin />
        </Button>
      </section>
      ...
      <Modal
        ...
        classNames={{
          wrapper: "z-[2000]",
          backdrop:
            "z-[2000] bg-gradient-to-br from-[#94B9FF]/45 to-[#CDFFD8]/45 backdrop-opacity-10",
          base: "z-[2000]",
                  ...
                  <div>
                    ...
                    {childWaypoints.map((wp, index) => (
                      ...
                      >
                        ...
                        <div>
                          <p className="mb-2 text-medium font-semibold">
                            {wp.name}
                          </p>
                    ...
                    <h2 className="mb-2">
                      <strong className="text-lg text-greenT font-semibold">
                        Distancia Total:
                      </strong>{" "}
                      {routeInfo.distance} metros
                    </h2>
